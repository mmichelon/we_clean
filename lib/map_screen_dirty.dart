...
class DirtyMapScreen extends StatefulWidget {
  ...
  DirtyMapScreen(this.name, this.email, this.StartLat, this.StartLon);
  @override
  State<DirtyMapScreen> createState() => MyDirtyMapState(name, email, StartLat, StartLon);
}

class MyDirtyMapState extends State<DirtyMapScreen> {
  final email;
  final name;
...
//  GoogleMapController mapController;
  ...
  MyDirtyMapState(this.name, this.email, this.StartLat, this.StartLon);
...
//      i++;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('All Dirty Locations'),
        ),
        body: Stack(
          children: <Widget>[
        // Google Map widget
